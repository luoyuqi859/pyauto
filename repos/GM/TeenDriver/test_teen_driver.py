...
#         e.click()
#         time.sleep(1)
#         el = d_obj(resourceId='com.gm.hmi.settings:id/rv_vehicle_sub_menu').child(className="android.view.ViewGroup",                                                                                index=3)
...
#         time.sleep(30)
#     with allure.step('14. Send below signal to Reset VSADP_VehSpdAvgDrvnAuth set to 0.0 VSADP_VehSpdAvgDrvnAuth_Inv set to False AutoTransGrDispdVal set to 1 = P AutoTransGrDispdVal_Inv set to False'):
...
#     with allure.step('17. Send below signals AutoTransGrDispdVal set to 3 = N AutoTransGrDispdVal_Inv set to False VSADP_VehSpdAvgDrvnAuth set to 0.0 VSADP_VehSpdAvgDrvnAuth_Inv set to False'):
...
#         time.sleep(30)
#     with allure.step('19. Send below signal to Reset VSADP_VehSpdAvgDrvnAuth set to 0.0 VSADP_VehSpdAvgDrvnAuth_Inv set to False AutoTransGrDispdVal set to 1 = P AutoTransGrDispdVal_Inv set to False'):
#         GMS.sendSignal(Signal='TEGP_TrnsShftLvrPstnAuth', Value=1, Type='Signal', Mode='HS')
#         GMS.sendSignal(Signal='TEGP_TrnsShftLvrPstnAuth_Inv', Value=0, Type='Signal', Mode='HS')
#         GMS.sendSignal(Signal='VSADP_VehSpdAvgDrvnAuth', Value=0.0, Type='Signal', Mode='HS')
#         GMS.sendSignal(Signal='VSADP_VehSpdAvgDrvnAuth_Inv', Value=0, Type='Signal', Mode='HS')
