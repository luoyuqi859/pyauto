...
class Page(object):
    ...
    #         (print("\n"), logger.info(msg=" 点击 ==> " + "点击坐标{},{}".format(x, y)))
    #
    ...
    #     logger.info("预期结果: " + describe + " 文案存在")
    #     if text_exists is True:
    #         insert_assert(describe, True)
    #         logger.info("实际结果: " + describe + " 文案存在")
    #     else:
    #         insert_assert(describe, False)
    #         logger.warning("实际结果: " + describe + " 文案不存在")
    #
...
class XpathElement(object):
    ...
    def click(self, screenshots=settings.click_screenshots):
        """
        Click element.
        """
        self.screenshots(describe="点击") if screenshots else (
        logger.info(msg="点击 ==> " + self.describe), print("\n"))
